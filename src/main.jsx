...
import Scaffolding from "./pages/Training Faculties/Earth Moving Equipment Training/Cranes,Forklifs,Trailors.jsx";
...
import EarthMovingEquipment from "./pages/Training Faculties/Earth Moving Equipment Training/Cranes,Forklifs,Trailors.jsx";
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<RootRoute />}>
      ...
      <Route path="Earthmoving" element={<EarthMovingEquipment />} />
