                ...
                <div className="font-sans p-6 font-medium text-sm">
                  <ul>
                    <li className="pt-2 pb-1">
                      <p>
                        Office 27, Ringback mall, <br /> Beside Mobil Filling
                        Station, <br /> Oribanwa Bus-stop,Ibeju-Lekki Lagos
                      </p>
                    </li>
                    <li className="pt-2 pb-1 hover:text-green-500">
                  ...
                  <div className="font-sans font-bold p-4 text-sm text-center">
                    ...
                    <div className="p-2 flex gap-4 justify-center">
                      <a href="https://www.instagram.com/scaftech.ng/">
                        <InstagramIcon className="bg-red-900 py-1 rounded-md w-8 h-8" />
                      </a>
                      {/* <a href="">
               <XIcon className="bg-black rounded-md py-1 w-8 h-8" />
               </a> */}
                      <a href="https://web.facebook.com/Scaftechengineeringservices?_rdc=1&_rdr">
                        <FacebookIcon className="bg-blue-600 py-1 rounded-md w-8 h-8" />
                      </a>
                      <a href="https://www.youtube.com/@scaftech_nigeria">
                        <YouTubeIcon className="bg-red-600 py-1 rounded-md w-8 h-8" />
                      </a>
                      <a href="https://www.linkedin.com/in/scaftech-engineering-services-61aaa0255/overlay/about-this-profile/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3BEJAG5KzyTZmwN7MS%2F4rbnA%3D%3D">
                        <LinkedInIcon className="bg-blue-900 py-1 rounded-md w-8 h-8" />
                      </a>
                    </div>
                  </div>
                </div>
