      ...
      <img className='w-full h-80 px-5 bg-cover bg-center cursor-pointer'
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            <article className="pl-15 text-sm text-gray-800 py-10">
              ...
              <p className="pt-5">
              Learn to implement sustainable construction practices with our specialized training program. Cover topics such as green building materials, waste management, <br /> energy efficiency, and environmental regulations. Contribute to a more sustainable future.
              </p>
