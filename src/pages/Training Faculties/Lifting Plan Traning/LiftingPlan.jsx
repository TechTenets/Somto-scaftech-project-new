            ...
            <h1 className='text-4xl text-gray-900 text-center font-bold pt-10 '>
                ...
                <p className='text-sm text-gray-800 py-5'>
                  ...
                  <div className='text-gray-800 text-sm text-center pt-5'>
                    ...
                    <p className='pt-5'>
                    Our courses cover every aspect of lifting operations, from initial equipment inspection and selection to advanced load handling and safety techniques. Our expert instructors, <br /> who possess extensive field experience, emphasize hands-on training, giving participants the skills they need to conduct lifting operations safely and effectively across the <br /> Oil & Gas, Marine, and Construction industries. With Scaftech's rigorous training, companies can enhance their workforce competence, and individuals can develop the <br /> critical skills necessary for career advancement in lifting operations.
                    </p>

                    <p className="pt-8 pl-8">
              <span className="text-blue-950 font-bold text-base">. Standards:</span> ASME B30 series, industry best practices standards.
              </p>
                  </div>
