            ...
            <h1 className='text-4xl text-gray-900 text-center font-bold pt-10 '>
                ...
                <p className='text-sm text-gray-800 py-5'>
                  ...
                  <div className='text-gray-800 text-sm text-center pt-5'>
                    <p>
                    Gain expertise in non-destructive testing techniques with our comprehensive NDT training. Learn to detect flaws and defects in materials without causing damage. <br /> Our program covers various NDT methods, including [list specific methods like UT, RT, MT, PT]. Ensure the quality and safety of your materials and structures.
                    </p>

                    <p className='pt-5'>
                    Our courses cover every aspect of integrity, from initial equipment inspection and selection to advanced load handling and safety techniques. Our expert instructors, <br /> who possess extensive field experience, emphasize hands-on training, giving participants the skills they need to conduct lifting operations safely and effectively across the <br /> Oil & Gas, Marine, and Construction industries. With Scaftech's rigorous training, companies can enhance their workforce competence. 
                    </p>
                  </div>
