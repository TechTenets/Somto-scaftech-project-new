        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            <h1 className='text-5xl text-gray-900 text-center font-bold pt-10 '>
                ...
                <p className='text-sm text-gray-800 py-5'>
                    Our Lifting Operations Programs are designed to equip personnel with the skills 
                    required to lift or move loads in accordance with the code of practice for safe use <br /> 
                    of Lifting Equipment. All our Lifting Training courses are accredited by NPORS, OPITO,
                     LEEA, and IADC-DIT for global recognition and standards.
                     </p>
                  ...
                  <div className='text-gray-800 text-sm text-center pt-5'>
                    <p>
                    JC International's Lifting Operations training is recognized for its excellence, accredited by LEEA, IADC, and OPITO accreditations, which highlight our commitment to delivering <br /> industry-approved standards. Our  accredited programs are developed to meet global benchmarks, ensuring that participants  receive up-to-date training that <br /> is both comprehensive and practical.
                    </p>
