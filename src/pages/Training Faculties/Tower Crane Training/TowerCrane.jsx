    ...
    <div className='w-full mt-20'>
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            <article className="pl-15 text-sm text-gray-800 py-10">
              <p>
              Specialize in the operation of tower cranes with our advanced training program. Learn to safely and efficiently operate tower cranes, including pre-operational inspections, <br />  load handling, and emergency procedures.Our training meets or exceeds industry standards and provides hands-on experience in a realistic environment.
              </p>
          ...
          <div className="flex-col  p-2 ">
            ...
            <div>
              <img className='rounded-lg ease-in-out w-80 h-48 hover:scale-105 transform transition duration-75'
