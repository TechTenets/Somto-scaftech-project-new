      ...
      <img className='w-full h-80 px-5 object-fill bg-center cursor-pointer'
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            <article className="pl-15 text-sm text-gray-800 py-10">
              <p>
              JC International offers IRATA-certified Rope Access Training at Levels 1, 2, and 3, empowering participants with the skills needed for safe, efficient work at height across  the Oil <br /> & Gas, Marine, and Construction industries. Our IRATA training covers essential safety protocols, advanced rescue techniques, and specialized rigging methods  tailored to real- <br />world applications.
              </p>
