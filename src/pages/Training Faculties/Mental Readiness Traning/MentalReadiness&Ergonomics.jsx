  ...
  return (
    <div className='w-full mt-20'>
      ...
      <img className='w-full h-80 px-5 bg-cover bg-center cursor-pointer'
             src="public/ergonomics-img.jpg" alt="" />
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            <div className='text-center'>
             ...
             <article className="pl-15 text-sm text-gray-800 py-10">
              <p>
              Scaftech Engineering Services’ Mental Readiness & Ergonomics Training equips workers with
              the psychological resilience and physical awareness needed to perform safely, <br /> efficiently, and
              sustainably. This expertly designed program by Scaftech Engineering Services combines mental
              alertness strategies, stress management, and ergonomic best <br /> practices to reduce fatigue, boost
              focus, and prevent musculoskeletal injuries and burnout, ensuring a healthier and more
            ...
            <p className='pt-3'>
                ...
                <p className='pt-3'>
                ●  Willingness to engage in self-awareness and workplace safety practices promoted by Scaftech Engineering Services
                </p>
                <p className='pt-3'>
             ...
             <p className='pt-5'>
                ...
                <p className='pt-3'>
                ● Learn techniques to manage stress, stay alert, and boost mental focus with guidance from Scaftech Engineering Services
                </p>
                <p className='pt-3'>
                ●  Identify and correct ergonomic hazards in the workplace
                </p>
                  <p className='pt-3'>
                ●  Apply posture, lifting, and workstation setup techniques to reduce strain and fatigue, as taught by Scaftech Engineering Services
                </p>
                  <p className='pt-3'>
                ●  Promote a culture of wellness, early symptom reporting, and self-care
                </p>
                <p className='pt-5'>
                ●  Support safe decision-making under pressure and in high-risk tasks aligned with Scaftech Engineering Services’ standards
                </p>
