      ...
      <img className='w-full h-80 px-5 bg-cover bg-center cursor-pointer'
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            MENTAL READINESS AND ERGONOMICS TRAINING
                ...
                Optimize Performance. Mental Readiness and Ergonomics.
                </p>
            ...
            <article className="pl-15 text-sm text-gray-800 py-10">
              ...
              <p className="pt-5">
              Promote employee well-being and productivity with our mental readiness and ergonomics training. Learn to manage stress, improve focus, and create a comfortable <br /> and safe work environment. Enhance employee performance and reduce workplace injuries.
              </p>
