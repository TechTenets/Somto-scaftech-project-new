      ...
      <img className='w-full h-80 px-5 cursor-pointer'
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            EMPLOYABILITY SKILLS TRAINING
                ...
                Are you a fresh graduate or non-graduate aspiring to build a successful career in the Oil & Gas Industry? This training is designed to help you gain essential skills that enhance <br /> your employability and set you on the path to success in the oil and gas, marine and construction industries.
                </p>
            ...
            <article className="pl-15 text-sm text-gray-800 py-10">
                 <p>
                 The Employability Skills program at JC International is designed specifically for fresh graduates and non-graduates who aspire to build a successful career in the Oil & Gas, <br /> Marine, and Construction industries. This comprehensive package not only includes essential safety training but also provides the foundational skills needed to work in some <br /> of the most demanding environments, including offshore installations.
                 </p>
          ...
          <div className="flex-col  p-2 ">
            <div>
              <img className='rounded-lg ease-in-out hover:scale-105 transform transition duration-75 w-80 h-48' 
              src="/images/What-fire.jpeg" alt="" />
            </div>
            <div className="text-blue-950 text-sm font-medium pt-5 ">
              <h1>Fire Warden and Marshall</h1>
            </div>
            <div className="text-gray-400 p-3">
              <InfoTwoToneIcon />2 Days
            </div>
          ...
          <div className="flex-col p-2 ">
            <div>
              <img className='rounded-lg  ease-in-out hover:scale-105 transform transition-all duration-75 w-80 h-48'
               src="/jci-9-24.jpg" alt="" />
            </div>
            <div className="text-blue-950 text-sm font-medium pt-5 ">
              <h1>Mobile Crane Operations</h1>
            </div>
            <div className="text-gray-400 p-3">
              <InfoTwoToneIcon />4 weeks
            </div>
          ...
          <div className="flex-col p-2 ">
            <div>
              <img className='rounded-lg  ease-in-out hover:scale-105 transform transition-all duration-75 w-80 h-48'
               src="/Confined-space.jpg" alt="" />
            </div>
            <div className="text-blue-950 text-sm font-medium pt-5 ">
              <h1>Confined Space Entry</h1>
            </div>
            <div className="text-gray-400 p-3">
              <InfoTwoToneIcon />2 Days
            </div>
