    ...
    <div className='w-full mt-20'>
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            MOBILE ELEVATED WORK PLATFORM(MEWP) SCISSORS LIFT TRAINING
                ...
                Master Safe MEWP Operation: Scissors Lift Training is fully accredited by The American Society for Non Destructive Testing (ASNT)
                </p>
            ...
            <article className="pl-15 text-sm text-gray-800 py-10">
              <p>
              Our comprehensive MEWP Scissors Lift training ensures operators are proficient in safe operation, pre-use inspections, and emergency procedures. Learn to navigate various work environments, understand load capacities, and comply with all relevant safety standards. Gain hands-on experience and certification to operate scissors lifts confidently and safely.
              </p>
              ...
              <span className="text-blue-950 font-bold text-base">. Standards:</span> OSHA,ANSI A2.22, and manufacturer's guidelines.
              </p>
            </article>
