  ...
  return (
    <div className='w-full mt-20'>
        ...
        <img className='w-full h-80 px-5 bg-cover bg-center cursor-pointer'
             src="public/mobile-elevate-img.jpg" alt="" />
        ...
        <div className='text-center bg-gray-100 w-auto h-auto'>
            ...
            MOBILE ELEVATED WORK PLATFORM(MEWP) SCISSORS LIFT TRAINING
                ...
                <span className="text-blue-950 font-bold text-base">Slogan:</span>  Rise Smartly with Confidence with Scaftech
                </p>
           ...
           <div className='text-center'>
              ...
              <p>
              Scaftech Engineering Services’ MEWP Scissor Lift Training prepares operators to safely and
              effectively operate scissor lifts in elevated work environments. This comprehensive <br /> course,
              designed by Scaftech Engineering Services, covers equipment controls, stability principles,
              hazard recognition, fall prevention, and emergency procedures, ensuring <br /> operators meet
              site-specific and international safety standards upheld by Scaftech Engineering Services.
              </p>
            ...
            <p className='pt-3'>
             ...
             <p className='pt-5'>
                ...
                ●  Operate MEWPs with a focus on balance, load management, and safe maneuvering
                  ...
                  <p className='pt-3'>
                ●  Apply safety procedures for elevation, descent, movement, and emergency lowering as taught by Scaftech Engineering Services
                </p>
                  <p className='pt-3'>
            ...
            <div className=''>
              <h1 className='text-xl text-gray-900 font-bold pt-7 '>
                      List of Courses Under Scaftech Engineering Services MEWP Scissor Lift Training
                </h1>
            </div>
